...
@Singleton
class CompanyProfileService @Inject()(storageConnector: PartnershipIdentificationConnector,
...
object CompanyProfileService {
  implicit val CompanyProfileWrites: OWrites[CompanyProfile] = Json.writes[CompanyProfile]
}
